...
class Game:
    ...
    def __init__(self, master):
        ...
        self.button_clicked_list = [self.one_clicked, self.two_clicked, self.three_clicked, self.four_clicked,
                                    self.five_clicked, self.six_clicked, self.seven_clicked, self.eight_clicked,
                                    self.nine_clicked]
        ...
        self.button_one = Button(text="", font="times 65 bold", fg="black", bg="green", width="6", bd=5, relief='solid',
                                 command=self.button_one_clicked)
        self.button_one.grid(row=1, column=0)

        self.button_two = Button(text="", font="times 65 bold", fg="black", bg="green", width="6", bd=5, relief='solid',
                                 command=self.button_two_clicked)
        self.button_two.grid(row=1, column=1)

        self.button_three = Button(text="", font="times 65 bold", fg="black", bg="green", width="6", bd=5,
                                   relief='solid', command=self.button_three_clicked)
        self.button_three.grid(row=1, column=2)

        self.button_four = Button(text="", font="times 65 bold", fg="black", bg="green", width="6", bd=5,
                                  relief='solid', command=self.button_four_clicked)
        self.button_four.grid(row=2, column=0)

        self.button_five = Button(text="", font="times 65 bold", fg="black", bg="green", width="6", bd=5,
                                  relief='solid', command=self.button_five_clicked)
        self.button_five.grid(row=2, column=1)

        self.button_six = Button(text="", font="times 65 bold", fg="black", bg="green", width="6", bd=5, relief='solid',
                                 command=self.button_six_clicked)
        self.button_six.grid(row=2, column=2)

        self.button_seven = Button(text="", font="times 65 bold", fg="black", bg="green", width="6", bd=5,
                                   relief='solid', command=self.button_seven_clicked)
        self.button_seven.grid(row=3, column=0)

        self.button_eight = Button(text="", font="times 65 bold", fg="black", bg="green", width="6", bd=5,
                                   relief='solid', command=self.button_eight_clicked)
        self.button_eight.grid(row=3, column=1)

        self.button_nine = Button(text="", font="times 65 bold", fg="black", bg="green", width="6", bd=5,
                                  relief='solid', command=self.button_nine_clicked)
        self.button_nine.grid(row=3, column=2)

        # List of all the buttons.

        self.buttons_list = [self.button_one, self.button_two, self.button_three, self.button_four, self.button_five,
                             self.button_six, self.button_seven, self.button_eight, self.button_nine]
